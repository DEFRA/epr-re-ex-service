...
Date: 2026-08-27
Status: Findings supporting ADR-0050. The model is settled; how the code should express it is proposed there.
Repos: `epr-backend`, `epr-frontend`, `epr-re-ex-admin-frontend`, `epr-re-ex-journey-tests`
Relates to: [ADR-0050](../decisions/0050-glass-as-two-material-types.md), PAE-837 (glass material type handling), PAE-844, PAE-939
...
[ADR-0050: Glass as two material types](../decisions/0050-glass-as-two-material-types.md), which proposes
