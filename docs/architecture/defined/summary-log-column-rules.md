<!-- GENERATED FILE - DO NOT EDIT BY HAND. Generated by DEFRA/epr-backend scripts/generate-column-rules.mjs. To update, re-run the tool and replace this file with its output. -->

# Summary Log Column Rules

A per-column reference of every rule applied to a Summary Log, for all five templates.

> ⚠️ **Generated file - do not edit by hand.** This page is produced by the column-rules generator, [`scripts/generate-column-rules.mjs`](https://github.com/DEFRA/epr-backend/blob/main/scripts/generate-column-rules.mjs) in the `DEFRA/epr-backend` repository, which introspects the live table schemas.
>
> To update it, run `node scripts/generate-column-rules.mjs` from an `epr-backend` checkout and replace this file with the output. Any manual edits will be lost the next time it is generated. Because it is derived from the code, it cannot drift from what actually validates uploads.
