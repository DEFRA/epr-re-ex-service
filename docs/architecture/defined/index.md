...
Documentation relating to architecture that is defined and agreed with project stakeholders.
...
3. [pEPR: High Level Design](pepr-hld.md)
4. [pEPR: Low Level Design](pepr-lld.md)
5. [pEPR: Low Level Design - Admin UI Authentication & Authorisation](pepr-lld-auth-admin-ui.md)
6. [pEPR: Low Level Design - API Authentication & Authorisation](pepr-lld-auth-api.md)
7. [pEPR: Low Level Design - UI Authentication & Authorisation](pepr-lld-auth-ui.md)
8. [EPR Frontend Page Navigation](epr-frontend-page-navigation.md)
9. [Forms data logical data model](forms-data-logical-data-model.md)
10. [Auditing organisation update](auditing-updates-to-organisation.md)
...
16. [Summary Log Rules Reference](summary-log-rules.md) (generated from code by the epr-backend tool)
